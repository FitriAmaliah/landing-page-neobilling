...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" id="navbar" style="background-color: #f7af46;">
  <div class="container">
    ...
    <!-- Home Section -->
      <section id="home" class="d-flex align-items-center" style="min-height: 85vh; background-color:#f7af46;" data-aos="zoom-in">
          <div class="container">
              <div class="row">
                  <!-- Text and Button Column -->
                  <div class="col-lg-6 col-md-12 d-flex flex-column justify-content-center pt-5 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
                      <h1 class="display-4 font-weight-bold mb-3">Welcome to NeoBilling</h1>
                      <p class="lead">
                          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec vehicula, risus eu scelerisque tristique, lectus eros faucibus tortor, id fringilla est purus in quam.
                      </p>
     ...
     <div class="col-lg-6 col-md-12 order-1 order-lg-2 home-img" data-aos="zoom-in" data-aos-delay="200">
      <img src="{{ asset('assets/img-1.png') }}" alt="Descriptive Text" class="img-fluid floating-img animate-float">
    </div>
  </div>
  </div>
  </section>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row content">
        ...
        <div class="col-lg-6">
          ...
          <a href="https://my.radboox.com/auth/register" class="btn-learn-more">Free Trial</a>
      </div>
  </div>
  </div>
  </section>
  ...
  <div class="col-lg-5 d-flex align-items-stretch order-2 order-lg-2 md:block">
    <div class="img-container">
      <img src="{{ asset('assets/img-2.png') }}" alt="Descriptive Text" class="img-fluid">
    </div>
  </div>
      </div>
...
<!-- Footer -->
<footer class="text-center py-4" style="background-color: #f7af46; width: 100%; position: relative;">
  <p class="mb-0">&copy; 2024 NeoBilling. All rights reserved.</p>
</footer>
